...
@section('content')
    <div class="max-w-md mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Novo Tipo</h1>
            <p class="text-gray-600 mt-1">Adicione uma nova categoria de produto</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ url('types/new') }}" method="POST" class="space-y-6">
                @csrf
